...
func (Policy) StrategyFor(region string, ctx cadence.RequestContext, prof cadence.Profile) cadence.Strategy {
	...
	return cadence.ActivationFold(plan.Activation, cadence.ActivationCases[cadence.Strategy]{
		...
		ActivateLoad: func() cadence.Strategy { return cadence.Deferred(cadence.Client(), cadence.OnLoad()) },
		ActivateVisible: func() cadence.Strategy { return cadence.Deferred(cadence.Client(), cadence.OnVisible()) },
		ActivateIntent: func() cadence.Strategy { return cadence.Deferred(cadence.Client(), cadence.OnHover()) },
	})
}
