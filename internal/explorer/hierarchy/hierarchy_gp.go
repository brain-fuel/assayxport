...
//
//goplus:instance SummaryMonoid "goforge.dev/goplus/std/algebra".Monoid[Summary]
var SummaryMonoid = func() algebra.Monoid[Summary] {
	w := &algebra.Monoid[Summary]{
		Combine: func(a, b Summary) Summary {
			return Summary{Symbols: a.Symbols + b.Symbols, Packages: a.Packages + b.Packages, HasEntrypoint: a.HasEntrypoint || b.HasEntrypoint}
		},
		Empty: func() Summary { return Summary{} },
	}
	return *w
}()
